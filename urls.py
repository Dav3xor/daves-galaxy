...
urlpatterns = patterns('',
    ...
    (r'^eradicate/$', 'newdominion.dominion.views.eradicate'),
    (r'^eradicated/$', 'newdominion.dominion.views.eradicated'),
    ...
    (r'^planets/(?P<planet_id>\d+)/energy/$', 'newdominion.dominion.views.planetenergy'),
